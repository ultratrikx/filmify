...
class FilmProfile:
    def __init__(self, name, color_curves, contrast, saturation, chromatic_aberration, blur, base_color, grain_amount,
                 grain_size):
        self.name = name
...
def apply_film_profile(img, profile, chroma_override=None, blur_override=None, color_temp=6500,
                       cross_process_flag=False):
...
def process_image(args):
    ...
    with Image.open(image_path) as img:
        ...
        processed_image = apply_film_profile(img, profile, chroma_override, blur_override, color_temp,
                                             cross_process_flag)
...
if __name__ == "__main__":
    ...
    for profile_name, profile in film_profiles.items():
        ...
        process_args.append(
            (args.input_image, profile, args.chroma, args.blur, args.color_temp, args.cross_process, output_filename))
